package com.b14.qdb.hadoop.mapreduce.examples.cards;
...
public class CardIT extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(CardIT.class);
    ...
    public void setUp() {
        ...
        try {
            String line = "";
            InputStream is = getClass().getClassLoader().getResourceAsStream("cardsinput.txt");
    ...
    public void tearDown() {
        try {
            if (qdbInstance != null) {
                // Check results
                IntWritable result = qdbInstance.get("clubs");
                assertTrue(result.get() == 19);
                
                result = qdbInstance.get("hearts");
                assertTrue(result.get() == 26);
    ...
    @Test
    public void testCardDriver() throws Throwable {
